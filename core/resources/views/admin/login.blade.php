                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal form-simple" action="{{ route('admin.login.post') }}" method="post" novalidate>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6 col-12 text-center text-md-right"><a href="{{ route('admin.password.request') }}" class="card-link white"><i class="fa fa-link"></i> Forgot Password?</a></div>
                                        </div>
