                                ...
                                <table class="table table-striped table-bordered table-hover zero-configuration">
                                    ...
                                    @foreach($history as $k => $p)
                                        <tr class="{{ $p->deleted_at != null ? 'bg-warning white' : '' }}">
                                            ...
                                            <td>
                                                @if($p->payment_type == 0)
                                                    <div class="badge badge-primary font-weight-bold text-uppercase">Delivery Payment</div>
                                                @else
                                                    <div class="badge badge-primary font-weight-bold text-uppercase">Normal Payment</div>
                                                @endif
                                            </td>
