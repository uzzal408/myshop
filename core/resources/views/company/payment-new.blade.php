                        ...
                        <div class="card-body">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select name="payment_type" id="payment_type" class="form-control select2 font-weight-bold">
                                            <option value="0" class="font-weight-bold">Delivery Payment</option>
                                            <option value="1" class="font-weight-bold">Normal Payment</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            <input class="form-control font-weight-bold input-lg pay_amount" id="pay_amount" name="pay_amount" value="{{ old('pay_amount') }}" placeholder="Pay Amount" type="text" >
                                ...
                                <div id="store_payment" style="display: block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <input class="form-control font-weight-bold input-lg" name="total_amount" value="{{ old('total_amount') }}" placeholder="Total Amount" type="text">
                                                <span class="input-group-addon"><strong>{{ $basic->currency }}</strong></span>
                                            </div>
                                        </div>
                                    </div>
